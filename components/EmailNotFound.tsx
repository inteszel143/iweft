...
export default function EmailNotFound({ modalVisible, setModalVisible }: ModalProps) {
        ...
        >
            <View style={styles.modalStyle}>
                <View style={styles.modalBox}>
                    ...
                    <Text style={styles.titleStyle}>Email not found !</Text>
                    <Text style={styles.subStyle}>The email you provided doesn't seem to be registered in our database.</Text>
