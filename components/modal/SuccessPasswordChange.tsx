...
export default function SuccessPasswordChange({ modalVisible, setModalVisible }: ModalProps) {
    return (
        <Modal
            animationType="fade"
            transparent={true}
        ...
        >
            <View style={styles.modalStyle}>
                <View style={styles.modalBox}>
                    ...
                    <Text style={styles.titleStyle}>Password updated successfully!</Text>
                    <Text style={styles.subStyle}>Your password has been changed successfully.</Text>
