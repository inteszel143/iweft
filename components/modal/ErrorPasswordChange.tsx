...
export default function ErrorPasswordChange({ modalVisible, setModalVisible }: ModalProps) {
    return (
        <Modal
            animationType="fade"
            transparent={true}
        ...
        >
            <View style={styles.modalStyle}>
                <View style={styles.modalBox}>
                    ...
                    <Text style={styles.titleStyle}>Invalid Old Password</Text>
                    <Text style={styles.subStyle}>Please enter the correct old password.</Text>
