...
export default function ErrorActivePromo({ modalVisible, setModalVisible }: ModalProps) {
    return (
        <Modal
            animationType="fade"
            transparent={true}
        ...
        >
            <View style={styles.modalStyle}>
                <View style={styles.modalBox}>
                    ...
                    <Text style={styles.titleStyle}>Activation failed</Text>
                    <Text style={styles.subStyle}>Discount already activated for this user</Text>
