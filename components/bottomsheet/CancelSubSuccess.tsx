...
export default function CancelSubSuccess({ modalVisible, setModalVisible }: ModalProps) {
        ...
        >
            <View style={styles.modalStyle}>
                <View style={styles.modalBox}>
                    ...
                    <Text style={styles.titleStyle}>Cancel Subscription Successful!</Text>
                    <Text style={styles.subStyle}>You have successfully canceled your subscription plan.</Text>
