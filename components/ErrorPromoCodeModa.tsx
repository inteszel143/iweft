...
export default function ErrorPromoCodeModa({ modalVisible, setModalVisible }: ModalProps) {
    const toggleModal = () => {
        ...
        >
            <View style={styles.modalStyle}>
                <View style={styles.modalBox}>
                    ...
                    <Text style={styles.titleStyle}>Invalid promo code</Text>
                    <Text style={styles.subStyle}>The promo code you entered is invalid. Please try again.</Text>
