                                    ...
                                    <View style={styles.cardLeft}>
                                        ...
                                        <View style={{ width: wp(45) }}>
                                            ...
                                            <View style={{ flexDirection: 'row', alignItems: 'center', gap: wp(2), marginTop: hp(1.5) }}>
                                                <Image source={item?.name === "Premium" ? require('@/assets/temp/subs/premium.jpg') : item?.name === "Basic Plan" ? require('@/assets/temp/subs/basic.jpg') : require('@/assets/temp/subs/platinum.jpg')} resizeMode='contain' style={{ width: wp(6), height: hp(4) }} />
