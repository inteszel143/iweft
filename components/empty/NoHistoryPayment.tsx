...
export default function NoHistoryPayment() {
    return (
        <View style={styles.container}>
            ...
            <View>
                <Text style={styles.textStyle}>You have no payment history.</Text>
                <Text style={styles.subText}>No payment history found. Start add booking to see your transactions here.</Text>
