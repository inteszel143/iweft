...
import PriorSubModal from '@/components/home/items/PriorSubModal';

export default function PriorPlanType() {
    ...
    return (
        <View style={styles.container}>
            {modalSuccess && <PriorSubModal modalVisible={modalSuccess} setModalVisible={setModalSuccess} />}
