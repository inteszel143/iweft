    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.containerStyle}>
                ...
                <Text style={styles.titleStyle}>Code has been send to +971 ******99</Text>
                <CodeField
                    ref={ref}
                    {...props}
                    value={value}
                ...
                <Text style={[styles.titleStyle, { marginTop: hp(8) }]}>Resend code in <Text style={{ color: '#0A5CA8' }}>{seconds}</Text> s</Text>
            </View>
